...
def test_deve_subtrair_valor_carterira_do_usuario_quando_este_propor_um_lance(vini, leilao):
...
def test_nao_deve_permitir_propor_lance_quando_o_valor_eh_maior_que_o_valor_da_carteira(vini, leilao):
